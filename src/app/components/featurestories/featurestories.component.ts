...
import { IArticleRecord } from 'src/app/types/article';

@Component({
  selector: 'hm-featurestories',
...
export class FeaturestoriesComponent implements OnInit {
  ...
  //featurearticls: IArticleRecord[] = FeatureStories;

  featureArticles: IArticleRecord[]
  constructor(private articleService: ArticleService) { }

  ngOnInit() {
    this.articleService.getFeatureArticles().subscribe(
      articles => {
...
const FeatureStories = [
  {
    ...
    abstract: 'The udpated Angular project template provides a convenient starting point for ASP.NET Core apps using Angular and the Angular CLI to the latest version',
    author: 'Wael Kdouh',
    date: '2019-04-02',
    readduration: 4
  },
  ...
  },
  {
    ...
    abstract: 'In this articla, the fundamentals of what JSON Web Tokens (JWT) are, and why they are used will be explained. JWT are an important piece in the development',
